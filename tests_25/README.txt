...
В корне расположен файл conftest.py, сожержащий фикстуры для настройки вебдрайвера, авторизации, перехода на нужную страницу и подсчёта количества фотографий в списке.
